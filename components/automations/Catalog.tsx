    ...
    <Reveal delay={(index % 3) * 0.06}>
      <TiltCard max={5}>
        <div
          ...
          className="card-lift group flex h-full flex-col rounded-md border border-line bg-elevated/40 p-5 transition-colors duration-500 hover:border-accent/40 hover:bg-elevated-2 focus-visible:border-accent focus-visible:bg-elevated-2 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
        >
